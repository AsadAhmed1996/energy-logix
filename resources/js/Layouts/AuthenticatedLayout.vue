...
<template>
    <div>
        <div class="min-h-screen bg-blue-50/20 dark:bg-[#0f172a]">
            <nav
                class="border-b border-[#244b7e] bg-[#1a365d]"
            >
                ...
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="flex h-16 justify-between">
                        ...
                        <div class="hidden sm:ms-6 sm:flex sm:items-center h-full">
                            <!-- Settings Dropdown -->
                            <div class="ms-3 h-full">
                                <Dropdown align="right" width="48" root-classes="relative h-full flex items-center" dropdown-classes="top-full mt-0 border border-gray-100 dark:border-slate-800/80 shadow-lg">
                                    <template #trigger>
                ...
                >
                    ...
                    <div
                        class="border-t border-[#244b7e] pb-1 pt-4"
                    >
                        <div class="px-4">
                            <div
                                class="text-base font-medium text-slate-200"
                            >
                                {{ $page.props.auth.user.name }}
                            </div>
            ...
            <!-- Page Heading -->
            <header
                class="bg-blue-50/80 shadow-sm dark:bg-[#131f33]/90 border-b border-blue-100/30 dark:border-slate-800/80"
                v-if="$slots.header"
            >
